...
public class EmailPasswordLoginAuthUser extends
	 ...
	 * @param email
	 */
	public EmailPasswordLoginAuthUser(final String email) {
		this(null, email);
	}

	public EmailPasswordLoginAuthUser(final String clearPassword,
			final String email) {
