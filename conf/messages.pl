...
error.min=Musi by? wi?ksze lub r—wne ni? {0}
error.max=Musi by? mniejsze lub r—wne ni? {0}
...
playauthenticate.verify_email.error.already_validated=Tw—j adres zosta? ju? zweryfikowany.
...
playauthenticate.reset_password.message.email_not_verified=Twoje konto nie zosta?o jeszcze zweryfikowane. Na wskazany adres zosta?y wys?ane instrukcje dotycz?ce weryfikacji. Dopiero po weryfikacji spr—buj przywr—ci? has?o w razie potrzeby.
...
playauthenticate.reset_password.message.success.auto_login=Twoje has?o zosta?o przywr—cone.
playauthenticate.reset_password.message.success.manual_login=Twoje has?o zosta?o przywr—cone. Zaloguj si? ponownie z u?yciem nowego has?a.
...
playauthenticate.login.email.placeholder=Tw—j adres e-mail
playauthenticate.login.password.placeholder=Podaj has?o
playauthenticate.login.password.repeat=Powt—rz has?o
...
playauthenticate.verify.account.first=musisz zweryfikowa? sw—j adres e-mail.
...
playauthenticate.link.account.false=Nie, wyloguj mnie i utw—rz nowe konto u?ytkownika
...
playauthenticate.verify.email.requirement=Musisz potwierdzi? sw—j adres e-mail, aby korzyta? z PlayAuthenticate
...
playauthenticate.password.reset.title=Przywr—? has?o
playauthenticate.password.reset.cta=Przywr—? moje has?o
...
playauthenticate.oauth.access.denied.alternative=Je?li wolisz tego nie robi? mo?esz r—wnie?
...
playauthenticate.navigation.link_more=Do??cz wi?cej dostawc—w
playauthenticate.navigation.logout=Wyloguj si?
playauthenticate.navigation.login=Zaloguj si?
playauthenticate.navigation.home=Strona g?—wna
...
playauthenticate.profile.mail=Nazywasz si? {0} a tw—j e-mail to {1}!
...
playauthenticate.index.heading=Nag?—wek
playauthenticate.index.details=Szczeg—?y
